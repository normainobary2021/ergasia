    ...
    return (
        <div className="flex flex-col gap-6">
                ...
                <CardContent>
                    <div className="flex flex-col gap-4">
                        ...
                        <form className="flex flex-col gap-4">
                            ...
                            <GeneralSubmitButton variant="outline" text="Login with Google" icon={<Google />} />
                        </form>
                    </div>
                </CardContent>
            </Card>
            ...
            <div className="text-xs text-center text-muted-foreground text-balance">
                By clicking "Login", you agree to our <a href="#" className="text-primary hover:underline">Terms of Service</a> and <a href="#" className="text-primary hover:underline">Privacy Policy</a>.
            </div>
        </div>
    )
}